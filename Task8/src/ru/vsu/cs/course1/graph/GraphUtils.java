...
public class GraphUtils {
    ...
    public static Graph fromStrWeighted(String str, Class clz) throws IOException, InstantiationException, IllegalAccessException {
        WeightedGraph graph = (WeightedGraph) clz.newInstance();
        Map<String, Integer> names = new HashMap<>();
        int vertexCount = 0;
        ...
        int edgeCount = scanner.nextInt();
        for (int i = 0; i < edgeCount; i++) {
            graph.addAdge(scanner.nextInt(), scanner.nextInt(), scanner.nextDouble());
        }
